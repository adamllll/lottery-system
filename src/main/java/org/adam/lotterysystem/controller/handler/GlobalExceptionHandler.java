...
public class GlobalExceptionHandler {
    ...
    public CommonResult<?> serviceException(ServiceException e) {
        ...
        return CommonResult.error(getErrorCode(e.getCode()), getErrorMsg(e.getMessage()));
    }
    ...
    private Integer getErrorCode(Integer code) {
        return code == null ? GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR.getCode() : code;
    }

    private String getErrorMsg(String message) {
        return StringUtils.hasText(message) ? message : GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR.getMsg();
    }
}
