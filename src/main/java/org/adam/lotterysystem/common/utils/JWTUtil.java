...
public class JWTUtil {
     ...
     * 密钥：Base64编码的密钥
     */
    private static final String SECRET = "1XXZW0usFzQRUOuovCQwBlkO+2j2LbZJzuH8jnpRzQo=";

    /**
     * 生成安全密钥：将一个Base64编码的密钥解码并创建⼀个HMAC SHA密钥。
     */
     ...
     * 生成密钥
     *
     * @param claim 载荷数据，可以包含用户信息等自定义内容{"id": 123, "username": "john_doe"}
     */
