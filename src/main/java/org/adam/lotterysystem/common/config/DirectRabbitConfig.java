...
public class DirectRabbitConfig {
    ...
    public Queue directQueue() {
        ...
        return QueueBuilder.durable(QUEUE_NAME)
                .deadLetterExchange(DLX_EXCHANGE_NAME) // 设置死信交换机
                .deadLetterRoutingKey(DLX_ROUTING) // 设置死信路由键
                .build();
    }
    ...
    /**
     * 绑定死信交换机 将队列和交换机绑定, 并设置用于匹配键：DlxDirectRouting
     *
     * @return
     */
    @Bean
    ...
    /**
     * Spring AMQP 4.x 中 Jackson2JsonMessageConverter 已弃用，改用 JacksonJsonMessageConverter。
     */
    @Bean
